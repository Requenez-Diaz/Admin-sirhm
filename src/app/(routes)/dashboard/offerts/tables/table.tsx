...
// import { EditOfferModal } from "../components/edit/editOferts";
...
//   const handleEditClick = (offer: Promotion) => {
...
//       // Ejemplo: await updatePromotion(selectedOffer.id, values);

//       // Actualiza el estado local
//       setOffers(
//         offers.map((offer) =>
//           offer.id === selectedOffer?.id ? { ...offer, ...values } : offer
//         )
//       );
...
//               offer={selectedOffer}
//               seasons={
//                 Array.isArray(selectedOffer.seasons)
//                   ? selectedOffer.seasons
//                   : []
//               }
//               bedrooms={selectedOffer.BedroomsPromotions || []}
